...
<div align="left">
    ...
    <a href="https://github.com/speakeasy-sdks/dg.git/actions"><img src="https://img.shields.io/github/actions/workflow/status/speakeasy-sdks/dg/speakeasy_sdk_generation.yml?style=for-the-badge" /></a>
...
```bash
pip install git+https://github.com/speakeasy-sdks/dg.git
```
...
```python
import tom
from tom.models import errors, shared
